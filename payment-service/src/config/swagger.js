      ...
      schemas: {
            ...
            data: {
              ...
              properties: {
                ...
                checkoutData: {
                  ...
                  nullable: true,
                  description:
                    "Gateway-specific checkout payload (null when mock provider is used)",
                },
              },
            },
          },
        ...
        PayPalNotifyRequest: {
          ...
          properties: {
            ...
            status_code: {
              type: "string",
              description: "2 means success in PayPal callback semantics",
              example: "2",
            },
            md5sig: {
              type: "string",
              example: "4F0CF5A07AF67A53F4A1A5D10C7A8775",
            },
            payment_id: {
              type: "string",
              example: "32001001",
