 ...
 * Provides API documentation for authentication endpoints
 */
...
const options = {
  definition: {
    ...
    servers: [
      ...
      {
        url: "https://auth-service-xxxxx-uc.a.run.app",
        ...
        RegisterRequest: {
          ...
          properties: {
            name: {
              type: "string",
              example: "John Doe",
              description: "User full name (max 50 characters)",
            },
            email: {
              type: "string",
              format: "email",
